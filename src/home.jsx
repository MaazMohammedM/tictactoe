...
import cross_icon from '../src/Icons/cross_icon.svg'
import circle_icon from '../src/Icons/cricle_icon.svg'
...
const Home = () => {
    ...
    const won =(winner)=>{
        setLock(true);
        if(winner === 'x'){
            titleRef.current.innerHTML = `Congrats You Won: <img src=${cross_icon} alt='cross icon'/>`
        } else{
            titleRef.current.innerHTML =`Congrats You Won: <img src=${circle_icon} alt='circle icon'/>`
        }
    }
